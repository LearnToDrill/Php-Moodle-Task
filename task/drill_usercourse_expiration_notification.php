...
class drill_usercourse_expiration_notification extends \core\task\scheduled_task
{
    ...
    */
    public function execute()
    {
        ...
        $records = $DB->get_recordset_sql("SELECT coursename,deviceid,useremail,firstname,notifydate FROM vw_user_course_expiration_notification where deviceid='edcd1a5de5676d56a804de745a14786fb425c8e76037e30b67bd5bbb59b94c50' ");
